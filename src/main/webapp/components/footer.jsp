    ...
    <div class="container p-4">
        ...
        <div class="row mt-4">
            ...
            <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
                <h5 class="text-uppercase">Sus</h5>

                <ul class="list-unstyled mb-0">
                    <li>
                        <a href="#" class="text-white"><i class="fas fa-book fa-fw fa-sm me-2"></i>Sus 1</a>
                    </li>
                    <li>
                        <a href="#" class="text-white"><i class="fas fa-book fa-fw fa-sm me-2"></i>Sus 2</a>
                    </li>
                    <li>
                        <a href="#" class="text-white"><i class="fas fa-user-edit fa-fw fa-sm me-2"></i>Sus 3</a>
                    </li>
                </ul>
            </div>
            <!--Grid column-->
            ...
            <!--Grid column-->
            <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
                <h5 class="text-uppercase">Headquarter</h5>

                <ul class="list-unstyled">
                    <li>
                        <a href="#!" class="text-white">The Wolf</a>
                    </li>
                    <li>
                        <a href="#!" class="text-white">123 Wall Street</a>
                    </li>
                    <li>
