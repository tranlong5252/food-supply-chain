            ...
            <div class="table-responsive">
                <table class="table table-sm table-primary table-striped table-hover caption-top table-bordered">
                    ...
                    <c:if test="${requestScope.companies != null}">
                        <c:forEach items="${requestScope.companies}" var="company">
                            <tr>
                                ...
                                <td>
                                    <label>
                                        <input class="form-control-plaintext" type="text" name="companyName"
                                ...
                                <td>
                                    <label>
                                        <input class="form-control-plaintext" type="text" name="companyTaxCode"
                                               form="edit_${company.id}"
                                ...
                                <td>
                                    <label>
                                        <select class="form-control-plaintext" name="companyRegion"
                                                form="edit_${company.id}" required>
                    ...
                    <tr>
                        ...
                        <td>
                            <label>
                                <input class="form-control-plaintext" type="text" name="companyName" form="add"
                                       placeholder="Enter name" required>
                            </label>
                        </td>
                        <td>
                            <label>
                                <input class="form-control-plaintext" type="text" name="companyTaxCode" form="add"
                        ...
                        <td>
                            <label>
                                <input class="form-control-plaintext" type="text" name="companySpecification" form="add"
